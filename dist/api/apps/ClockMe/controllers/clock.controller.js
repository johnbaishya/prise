...
const ClockMeUserSiteAssigned_1 = __importDefault(require("../../../../apps/ClockMe/models/ClockMeUserSiteAssigned"));
const Clock_1 = __importDefault(require("../../../../apps/ClockMe/models/Clock"));
const auth_1 = require("../../../../libs/auth");
const enums_1 = require("../../../../apps/ClockMe/types/enums");
...
const updateClock = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let axnEnm = enums_1.ClockActionType;
        let action = body.action;
        let status = enums_1.clockStatus.active;
        switch (action) {
            case axnEnm.clock_out:
                status = enums_1.clockStatus.completed;
                break;
            case axnEnm.break_start:
                status = enums_1.clockStatus.inactive;
                break;
            case axnEnm.break_end:
                status = enums_1.clockStatus.active;
            default:
                break;
        }
        let newBody = {
