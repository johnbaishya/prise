...
import { addSite, addSiteGallery, deleteSite, deleteSiteGalleryImage, getMySites, getSiteDetail, getSiteGallery, getsitesByCompanyId, updateSite } from "./controller/site.controller";
import { assignUserToSite, deleteUserSiteAssigned, getSiteAssignedBySiteId, getSitesAssigned, updateUserSiteStatus } from "./controller/userSiteAssigned.controller";
import { createSchedule, deleteSchedule, getScheduleByUserSiteAssign, getScheduleDetail, updateSchedule } from "./controller/userSiteSchedule.controller";
import { test1 } from "./controller/testController";
import uploadImage from "../../middleware/uploadImage";
import { startClock, updateClock } from "./controller/clock.controller";
